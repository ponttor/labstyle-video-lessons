...
export default class Lesson0 extends React.Component {
  render() {
    ...
    return (
      <div style={style}>
        <iframe width='660' height='420' src='https://activate.infoprotector.com/cover/frame.php?video=8f9a224e-94a1-4421-b6e3-10107b152865' frameborder='0' referrerpolicy='unsafe-url'></iframe>
      </div>
    )
  }
}
