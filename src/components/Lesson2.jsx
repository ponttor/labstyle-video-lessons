...
export default class Lesson0 extends React.Component {
  render() {
    ...
    return (
      <div style={style}>
        <iframe width='660' height='420' src='https://activate.infoprotector.com/cover/frame.php?video=971a315c-5465-4a62-9446-f806796742b0' frameborder='0' referrerpolicy='unsafe-url'></iframe>
      </div>
    )
  }
}
