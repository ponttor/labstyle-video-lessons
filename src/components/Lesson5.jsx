...
export default class Lesson0 extends React.Component {
  render() {
    ...
    return (
      <div style={style}>
        <iframe width='660' height='420' src='https://activate.infoprotector.com/cover/frame.php?video=3f610038-0751-42b7-9456-b9ae5c774fd8' frameborder='0' referrerpolicy='unsafe-url'></iframe>
      </div>
    )
  }
}
